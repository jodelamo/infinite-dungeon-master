...
Full class details including hit die, armor/weapon proficiencies, skill options, saving throws, and level-by-level features. For a compact table view with subclass options, see `.github/skills/level-up/class-features.md`.
