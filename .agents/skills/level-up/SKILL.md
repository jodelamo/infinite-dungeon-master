...
Open the scene with a **header banner** (see [`RULES.md` § "Display Formatting — Scene Banners"](RULES.md#display-formatting--scene-banners)) using the ⬆️ LEVEL UP scene type, showing the level change and current day.
...
Display a **level-up summary** (see [`RULES.md` § "Display Formatting — Level-Up Summary"](RULES.md#display-formatting--level-up-summary)) showing the HP roll, new max HP, and all features gained at the new level.
...
Close with a **status footer** (see [`RULES.md` § "Display Formatting — Scene Banners"](RULES.md#display-formatting--scene-banners)).
